...
public class ElectionTesterV7 {
    public static void main(String[] args) {
        Candidate2[] candidates = { new Candidate2("Bob", 31), new Candidate2("Phil", 9), new Candidate2("Mary", 43),
                new Candidate2("Sara", 12), new Candidate2("Bill", 28) };
        ...
        candidates = insertBefore(candidates, "Anna", "Dobby", 33);
        showTable(candidates, countVotes(candidates));

        System.out.println("\n\n\t<-< Delete 6 >->");
        candidates = deleteLocation(candidates, 6);
        showTable(candidates, countVotes(candidates));

        System.out.println("\n\n\t<-< Delete Phil >->");
        candidates = deleteName(candidates, "Phil");
        showTable(candidates, countVotes(candidates));
    }
    ...
    public static Candidate2[] deleteLocation(Candidate2[] candidates, int index) {
        Candidate2[] newArray = new Candidate2[candidates.length - 1];
        int add = 0;
    ...
    public static Candidate2[] deleteName(Candidate2[] candidates, String name) {
        int index = -1;
        ...
        return deleteLocation(candidates, index);
    }
}