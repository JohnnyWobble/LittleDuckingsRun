...
public class ElectionTesterV8 {
    public static void main(String[] args) {
        ...
        insertBefore(candidates, "Anna", "Dobby", 33);
        showTable(candidates, countVotes(candidates));

        System.out.println("\n\n\t<-< Delete 6 >->");
        deleteLocation(candidates, 6);
        showTable(candidates, countVotes(candidates));

        System.out.println("\n\n\t<-< Delete Phil >->");
        deleteName(candidates, "Phil");
        showTable(candidates, countVotes(candidates));
    }
    ...
    public static void deleteLocation(List<Candidate2> candidates, int index) {
        candidates.remove(index);
    }

    public static void deleteName(List<Candidate2> candidates, String name) {
        int index = -1;
        ...
        deleteLocation(candidates, index);
    }
}